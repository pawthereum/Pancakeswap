...
var Logo = function (_a) {
    ...
    return React.createElement("img", { src: 'https://ipfs.io/ipfs/QmW1QnHCFQ5W7pmN8QHiFxMtvL4meRTZigfpwzWw6mr5rT', width: '25%' }, null)
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "PawSwap homepage" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "PawSwap homepage" }, innerLogo))));
};
...
var socials = [
    {
        ...
        items: [
            {
                label: "Pawthereum",
                href: "https://t.me/pawthereum",
            },
            {
                label: "Pawth Price Chat",
                href: "https://t.me/Pawth",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/pawthereum",
    },
];
var MENU_HEIGHT = 64;
...
var baseColors = {
    failure: "#f03c4b",//"#ED4B9E",
    primary: "#ff65b3",//"#1FC7D4",
    primaryBright: "#ff65b3",//"#53DEE9",
    primaryDark: "#a1005b", //"#0098A1",
    secondary: "#7645D9",
    success: "#2ed99a",//"#31D0AA",
    warning: "#FFB237",
};
var brandColors = {
    binance: "#F0B90B",
};
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#faf9fa", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#f4eaf3", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#4f3a5c", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #f03c4b 0%, #ffeffa 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#A28BD4", borderColor: "#524B63", card: "#27262c", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #542a4a 100%)",
    } });
